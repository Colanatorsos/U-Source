  ...
  return (
    <>
      <div className={styles.Macbook}>
        ...
        <div className={!visible ? styles.dNone : styles.video}><iframe width="408.231" height="270" src="https://www.youtube.com/embed/dQw4w9WgXcQ?si=7_M3B1hcQ-QDoThl" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div>
      </div>
    </>
  )
}
